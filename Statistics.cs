...
namespace Statistics
{
    ...
    public static class Statistics
    {
        ...
        {
           Dictionary<int, int> valueFrequencyMap = new Dictionary<int, int>();

           foreach (var value in source)
           {
               if (valueFrequencyMap.ContainsKey(value))
           ...
           int maxFrequency = valueFrequencyMap.Values.Max();

           List<int> modes = new List<int>();

           foreach (var keyValue in valueFrequencyMap )
           {
               if(keyValue.Value == maxFrequency) 
                   modes.Add(keyValue.Key);
           }
